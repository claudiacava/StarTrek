...
can also be combined with other tools (within or out of the scope of R and Bioconductor [Gentleman et al ., 2004, Carey et al., 2005]), to build  exible analysis pipelines. In this vignette we demonstrate the cooperation between `StarTrek` and other tools with several examples.
