...
```{r, eval = TRUE}
score_euc_dist<-euc_dist_crtlk(dataFilt=Data_CANCER_normUQ_filt,pathway=path)
```
...
Visualization of the pathway cross-talk network. This function uses the relationship among genes as correlation  (green for positive correlations and red for negative correlations) and the width of the lines indicates the strength of the correlation. 
