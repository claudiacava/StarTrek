...
Visualization of the pathway cross talk network. This function uses the relationship among genes as correlation  (green for positive correlations and red for negative correlations) and the width of the line indicates the strength of the correlation. 
...
r<-qgraph(mt$corr, groups=mt$gruppi, mar=c(1,1,1,1),minimum=0.6)
```
